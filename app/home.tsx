...
import WoofCard from '../src/components/WoofCard';
import WoofPost from '../src/components/WoofPost';

const HomeScreen = () => {
  return (
    <ScrollView style={styles.container}>
      
      <Text style={styles.heading}>Trending Woofs</Text>
      <FlatList
        horizontal
        data={data.woofs}
        renderItem={({ item }) => (
      ...
      <Text style={styles.heading}>New Woof Posts</Text>
      <FlatList
